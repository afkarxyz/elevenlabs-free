document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupDashboardFeatures() {
        ...
        if (ttsForm) ttsForm.addEventListener('submit', async function(e) {
            ...
            speedRange.value = savedSpeed; speedValueDisplay.textContent = `${parseFloat(savedSpeed).toFixed(2)}`;
            speedRange.addEventListener('input', () => {
                speedValueDisplay.textContent = `${parseFloat(speedRange.value).toFixed(2)}`;
            ...
            resetSpeedButton.addEventListener('click', () => {
                speedRange.value = '1.00'; speedValueDisplay.textContent = '1.00';
