document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateVoiceSelect(voices) {
        ...
        voices.forEach(voice => {
            ...
            const voiceName = toTitleCase(voice.name || 'Unnamed Voice');
            
            let language = (voice.language || '').toLowerCase() === 'id' ? 'Indonesian' : 'English';
            
            const labels = voice.labels || {};
            
            const tags = [
                { class: 'tag-language', value: language, show: language !== 'English' },
                { class: 'tag-gender', value: toTitleCase(labels.gender || 'Unspecified'), show: labels.gender && labels.gender !== 'Unspecified' },
                { class: 'tag-age', value: toTitleCase(labels.age || 'Unspecified'), show: labels.age && labels.age !== 'Unspecified' },
                { class: 'tag-accent', value: toTitleCase(labels.accent || 'Unspecified'), show: labels.accent && labels.accent !== 'Unspecified' },
                { class: 'tag-description', value: toTitleCase(labels.description || 'No description'), show: labels.description && labels.description !== 'No description' },
                { class: 'tag-usecase', value: toTitleCase(labels.use_case || 'General'), show: labels.use_case && labels.use_case !== 'General' }
            ];
